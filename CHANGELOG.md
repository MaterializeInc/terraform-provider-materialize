...
### Features
* Improved ID structuring in Terraform state file with region-prefixed IDs, enhancing state management to allow supporting new features like managing cloud resources ([#400](https://github.com/MaterializeInc/terraform-provider-materialize/issues/401), [#401](https://github.com/MaterializeInc/terraform-provider-materialize/issues/401), [#402](https://github.com/MaterializeInc/terraform-provider-materialize/issues/402), and [#406](https://github.com/MaterializeInc/terraform-provider-materialize/issues/406))
