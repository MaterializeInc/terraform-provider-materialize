...
func TestAccSinkKafkaAvro_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSinkKafkaAvroResourceWithTopicOptions(sinkName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSinkKafkaExists("materialize_sink_kafka.test"),
					...
					resource.TestCheckResourceAttr("materialize_sink_kafka.test", "topic_replication_factor", "3"),
					...
					resource.TestCheckResourceAttr("materialize_sink_kafka.test", "format.0.avro.0.avro_doc_column.0.object.0.name", "accounts"),
					...
					resource.TestCheckResourceAttr("materialize_sink_kafka.test", "format.0.avro.0.avro_doc_column.1.object.0.name", "accounts"),
...
func testAccSinkKafkaAvroResourceWithTopicOptions(sinkName string) string {
	return fmt.Sprintf(`
