		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// resource.TestCheckTypeSetElemAttr("materialize_source_postgres.test", "table.0.name.*", "table1"),
					// resource.TestCheckTypeSetElemAttr("materialize_source_postgres.test", "table.0.alias.*", fmt.Sprintf(`%s_table1`, connName)),
					// resource.TestCheckTypeSetElemAttr("materialize_source_postgres.test", "table.1.name.*", "table3"),
					// resource.TestCheckTypeSetElemAttr("materialize_source_postgres.test", "table.1.alias.*", fmt.Sprintf(`%s_table3`, connName)),
					testAccCheckSourcePostgresExists("materialize_source_postgres.test_role"),
