...
func TestConnectionStringTesting(t *testing.T) {
	...
	r.Equal(`postgres://user:pass@host:6875/database?sslmode=disable&enable_rbac_checks=true&enable_ld_rbac_checks=true&enable_managed_clusters=true&application_name=tf`, c)
}
