		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("materialize_source_sqlserver.test", "text_columns.#", "1"),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("materialize_source_sqlserver.test", "table.0.upstream_name", "table1"),
					resource.TestCheckResourceAttr("materialize_source_sqlserver.test", "table.0.name", fmt.Sprintf(`%s_table1`, connName)),
					resource.TestCheckResourceAttr("materialize_source_sqlserver.test", "table.1.upstream_name", "table3"),
					resource.TestCheckResourceAttr("materialize_source_sqlserver.test", "table.1.name", fmt.Sprintf(`%s_table3`, connName)),
