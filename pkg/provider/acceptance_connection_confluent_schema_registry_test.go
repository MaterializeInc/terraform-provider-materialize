		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// resource.TestCheckNoResourceAttr("materialize_connection_confluent_schema_registry.test", "ssl_certificate_authority"),
					// resource.TestCheckNoResourceAttr("materialize_connection_confluent_schema_registry.test", "ssl_certificate"),
					// resource.TestCheckNoResourceAttr("materialize_connection_confluent_schema_registry.test", "ssl_key"),
					// resource.TestCheckNoResourceAttr("materialize_connection_confluent_schema_registry.test", "password"),
					// resource.TestCheckNoResourceAttr("materialize_connection_confluent_schema_registry.test", "username"),
					// resource.TestCheckNoResourceAttr("materialize_connection_confluent_schema_registry.test", "ssh_tunnel"),
					// resource.TestCheckNoResourceAttr("materialize_connection_confluent_schema_registry.test", "aws_privatelink"),
