...
func (b *SourceTableSqlServerBuilder) TextColumns(c []string) *SourceTableSqlServerBuilder {
	b.textColumns = c
	return b
}

func (b *SourceTableSqlServerBuilder) IgnoreColumns(c []string) *SourceTableSqlServerBuilder {
	b.ignoreColumns = c
	return b
}

func (b *SourceTableSqlServerBuilder) Create() error {
	return b.BaseCreate("sql-server", func() string {
		q := strings.Builder{}
		var options []string
...
func (b *SourceTableSqlServerBuilder) Rename(name string) error {
	return b.SourceTableBuilder.Rename(name)
}

func (b *SourceTableSqlServerBuilder) Drop() error {
	return b.SourceTableBuilder.Drop()
}
